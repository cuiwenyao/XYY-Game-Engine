...
// constructor
XYY_MeshResource::XYY_MeshResource(std::vector<Vertex> vertices, std::vector<unsigned int> indices, std::vector<XYY_TextureResource> textures)
{
...
// render the mesh
void XYY_MeshResource::draw(XYY_ShaderResource & shader)
{
	// std::cout << "绘制mesh中" << std::endl;
...
void XYY_MeshResource::setupMesh()
{
