...
XYY_Window::XYY_Window(unsigned int scr_windth, unsigned int scr_height, bool isFull, unsigned int gl_version_major, unsigned int gl_version_minor)
{
	...
	this->window = glfwCreateWindow(scr_windth, scr_height, title.c_str(), isFullScreenMonitor, NULL);
	if (window == NULL)
	{
