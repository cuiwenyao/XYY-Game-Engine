...
int XYY_GlobalIODriver::getKey(XYY_Window* win, int key)
{
	return glfwGetKey(win->getwindow(),key);
}
void XYY_GlobalIODriver::GetCursorPos(XYY_Window* win,double * x,double * y)
{
